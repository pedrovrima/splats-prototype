...
const PlotButtons = (props) => {
  ...
  const allStations = regions.reduce(
    (cont, reg) => [...cont, ...reg.stations],
    []
  );
    ...
    <>
      <div className="grid grid-cols-4 ">
        ...
        <div className="col-span-1 flex justify-center">
          <button
            className={`${
              activeMenu === "download" ? "btn-top-active-flex" : ""
            } btn-top-add-flex`}
            onClick={() => {
      ...
      <div>
        ...
        >
          <DownloadButtons
            ...
            hyCollapse={hyCollapse}
            ahyCollapse={ahyCollapse}
          ></DownloadButtons>{" "}
        </div>
